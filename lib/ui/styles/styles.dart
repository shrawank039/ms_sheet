...
Color primaryColor = const Color(0xff003826);
Color accentColor = const Color(0xff007953);
Color accentColorLight = const Color(0x38003826);
Color textColor = const Color(0xff12121D);
Color textGray = const Color(0xff777777);
...
Color buttonColor = const Color(0xff003826);
